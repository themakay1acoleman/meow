        ...
        <div style={{ position: 'relative', minHeight: '100vh', paddingBottom: '100px', fontFamily: "'VT323', monospace" }}>
            ...
            <div style={{ position: 'fixed', left: 0, top: 0, height: '100%', width: '60px', background: 'transparent', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'spaceAround', padding: '10px 0', zIndex: 1 }}>
                {Array(20).fill(0).map((_, i) => (
                    <img key={i} src="/heart.png" alt="Heart" style={{ width: '35px', height: 'auto', filter: 'drop-shadow(3px 3px 0 #999)', marginBottom: '10px' }} />
                ))}
            </div>
            ...
            <header style={{ background: '#fff', border: '4px solid #000', boxShadow: '10px 10px 0 #ffb6c1', padding: '20px', margin: '20px auto', textAlign: 'center', width: '50%', position: 'relative', zIndex: 10 }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '20px' }}>
                    <img src="/cupid2.png" alt="cupid" style={{ width: '80px', height: 'auto', filter: 'drop-shadow(3px 3px 0 #999)' }} />
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: '40px', margin: '40px auto', width: '90%', maxWidth: '1200px', position: 'relative', zIndex: 10 }}>
                ...
                <div style={{ position: 'relative', width: '48%' }}>
                    <div style={{ position: 'absolute', top: '-40px', left: '-30px', zIndex: 20 }}>
                        <img src="/2hearts.png" alt="Hearts" style={{ width: '100px', height: 'auto' }} />
                    </div>
                    <div style={{ background: '#ffe6f0', border: '8px solid #a00', padding: '40px 20px', textAlign: 'center', minHeight: '150px', maxHeight: '300px', overflowY: 'auto', boxShadow: '10px 10px 0 #999', fontSize: '1.2rem', lineHeight: '2' }}>
                ...
                <div style={{ position: 'relative', width: '48%' }}>
                    <div style={{ position: 'absolute', top: 'auto', bottom: '100%', right: '10px', zIndex: 20, textAlign: 'right' }}>
                        <img src="/movingpaws.gif" alt="Moving Paws" style={{ width: '150px', height: 'auto', marginBottom: '-48px' }} />
                    </div>
                    <div style={{ background: '#fff', border: '8px solid #999', padding: '40px 20px', textAlign: 'center', minHeight: '300px', maxHeight: '400px', overflowY: 'auto', boxShadow: '10px 10px 0 #ffb6c1', fontSize: '1.2rem', lineHeight: '2' }}>
            ...
            <div style={{ position: 'relative', width: '80%', maxWidth: '1000px', margin: '60px auto', zIndex: 10 }}>
                <div style={{ position: 'absolute', top: '-50px', left: '-40px', zIndex: 20 }}>
                    <img src="/star.png" alt="Star" style={{ width: '100px', height: 'auto' }} />
                </div>
                <div style={{ background: '#c5e1f1', border: '8px solid #07135b', padding: '40px 20px', textAlign: 'center', minHeight: '200px', boxShadow: '10px 10px 0 #bbb', fontSize: '1.2rem', lineHeight: '2' }}>
