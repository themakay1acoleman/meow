...
const Main = () => {
    ...
    return (
        <div style={{ position: 'relative', minHeight: '100vh', paddingBottom: '100px' }}>
            ...
            <img src={`${import.meta.env.BASE_URL}kitty2.gif`} alt="Kitty" style={{ position: 'absolute', top: '350px', right: '130px', width: '100px', height: 'auto' }} />
            ...
            <div className="heart-image" style={{ position: 'absolute', top: 'auto', bottom: '20px', left: '60%', transform: 'translateX(-50%)', margin: '0', textAlign: 'center', display: 'flex', alignItems: 'flexEnd', gap: '32px', justifyContent: 'center' }}>
                <Link to="/love">
                    <img src={`${import.meta.env.BASE_URL}heart.png`} alt="heart" className="heart-hover" style={{ maxWidth: '450px', width: '100%', height: 'auto', marginRight: '0', filter: 'drop-shadow(3px 3px 0 #999)' }} />
                </Link>
                <div style={{ position: 'relative', display: 'inline-block', height: '200px', width: '260px', transform: 'translate(-160px, -170px)' }}>
                    <img src={`${import.meta.env.BASE_URL}speechbubble.png`} alt="speech bubble" style={{ height: '200px', width: '100%', display: 'block' }} />
            ...
            <div style={{ textAlign: 'right', marginTop: '40px', marginBottom: '40px', marginRight: '20px' }}>
                <img src={`${import.meta.env.BASE_URL}cinamaroll.gif`} alt="Cinnamoroll" style={{ width: '200px', height: 'auto' }} />
            </div>
